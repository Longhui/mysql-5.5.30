...
#define MYSQL_STATISTICS_PLUGIN		 8  /* the statistics plugin type */
...
/*
  API for Statistics plugin. (MYSQL_STATISTICS_PLUGIN)
*/
 #define MYSQL_STATISTICS_INTERFACE_VERSION 0x0100

 /**
	Statistics plugin descriptor
 */
 struct st_mysql_statistics_engine
 {
    int interface_version;
 };
