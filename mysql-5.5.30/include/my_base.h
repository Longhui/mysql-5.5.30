...
#define HA_CLUSTERING         131072    /* for TOKUDB: Clustering key */

        /* The combination of the above can be used for key type comparison. */
#define HA_KEYFLAG_MASK (HA_NOSAME | HA_PACK_KEY | HA_AUTO_KEY | \
                         HA_BINARY_PACK_KEY | HA_FULLTEXT | HA_UNIQUE_CHECK | \
                         HA_SPATIAL | HA_NULL_ARE_EQUAL | HA_GENERATED_KEY | HA_CLUSTERING)
...
#define HA_ERR_CPU_TIMES_LIMITED 183
#define HA_ERR_IO_READS_LIMITED 184
#define HA_ERR_TRX_CPU_TIMES_LIMITED 185
#define HA_ERR_TRX_IO_READS_LIMITED 186
#define HA_ERR_PROFILER_ACCESS_DENIED 187
#define HA_ERR_PROFILE_ALREADY_EXISTS 188
