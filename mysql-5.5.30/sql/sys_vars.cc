...
static Sys_var_mybool Sys_wait_rollback_ok(
	   "startup_wait_rollback_ok",
	   "Wait InnoDB rollback compeleted in recovering before" 
	   "MySQL serve startup finish",
	   READ_ONLY GLOBAL_VAR(wait_rollback_ok),
	   CMD_LINE(OPT_ARG), DEFAULT(FALSE));
