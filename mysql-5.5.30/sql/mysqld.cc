...
/*transfer*/
ulong sql_thread_number;
ulong transfer_slave_thread= 0;
bool opt_enable_transfer= 0;
/*transfer end*/
...
SHOW_VAR com_status_vars[]= {
  ...
  {"show_plugin_status",   (char*) offsetof(STATUS_VAR, com_stat[(uint) SQLCOM_SHOW_PLUGIN_STATUS]), SHOW_LONG_STATUS},
...
PSI_mutex_key key_BINLOG_LOCK_index, 
  key_BINLOG_LOCK_xid_list, key_BINLOG_LOCK_prep_xids,
...
static PSI_mutex_info all_server_mutexes[]=
{
  ...
  { &key_LOCK_pending_checkpoint, "TC_LOG_MMAP::LOCK_pending_checkpoint", 0},
#endif /* HAVE_MMAP */
  ...
  { &key_LOCK_commit_log, "LOCK_commit_log", PSI_FLAG_GLOBAL},
...
static PSI_rwlock_info all_server_rwlocks[]=
{
  ...
  { &key_rwlock_rli_table_field_lock, "Relay_info_table_access::field_lock", 0},
  { &key_rwlock_rli_workers_lock, "Relay_log_info::LOCK_workers"}
};
