...
extern my_bool opt_log, opt_slow_log, opt_slow_io_log, opt_use_profile_limitted, opt_use_profile_repl;
...
extern ulong		   num_commits;
extern ulong		   num_group_commits;
