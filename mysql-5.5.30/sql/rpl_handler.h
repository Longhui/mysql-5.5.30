...
class Binlog_relay_SQL_delegate
  :public Delegate {
public:
  typedef Binlog_relay_SQL_observer Observer;
  int after_apply_event(THD *thd, Relay_log_info *rli);
private:
  void init_param(Binlog_relay_SQL_param *param, Relay_log_info *rli);
};
...
extern Binlog_relay_SQL_delegate *binlog_relay_sql_delegate;
#endif /* HAVE_REPLICATION */
