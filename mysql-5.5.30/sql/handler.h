...
struct xid_t {
  ...
  { return eq(xid->formatID, xid->gtrid_length, xid->bqual_length, xid->data); }
  bool eq(long f, long g, long b, const char *d)
  { return f== formatID && g == gtrid_length && b == bqual_length && !memcmp(d, data, g+b); }
...
struct handlerton
{
  ...
  */
   ...
   */
   ...
   bool (*rollback_ok)(handlerton *hton);
