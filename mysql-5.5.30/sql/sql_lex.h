...
enum enum_sql_command {
  ...
  SQLCOM_SHOW_SLAVE_HOSTS, SQLCOM_SHOW_SLAVE_SQL_THREAD, SQLCOM_DELETE_MULTI, SQLCOM_UPDATE_MULTI,
  ...
  SQLCOM_SHOW_SQL_STATS, SQLCOM_SHOW_TABLE_STATS, SQLCOM_SHOW_PLUGIN_STATUS,
  SQLCOM_BACKUP,
