...
class MYSQL_BIN_LOG: public TC_LOG, private MYSQL_LOG
{
 private:
  struct group_commit_entry
  {
	...
	/*
	 ...
	 that does not implement the commit_checkpoint_request() handlerton method)
	*/
	bool need_unlog;
	/*
	 Fields used to pass the nessary information to the last thread in a
  ...
  */
  ...
  friend void binlog_checkpoint_callback(void *cooie);
