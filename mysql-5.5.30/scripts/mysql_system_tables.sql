...
-- Create slow_log MyISAM.
CREATE TABLE IF NOT EXISTS slow_log (start_time TIMESTAMP NOT NULL, user_host MEDIUMTEXT NOT NULL, query_time TIME NOT NULL, lock_time TIME NOT NULL, rows_sent INTEGER NOT NULL, rows_examined INTEGER NOT NULL, logical_reads INTEGER NOT NULL, physical_reads INTEGER NOT NULL, db VARCHAR(512) NOT NULL, last_insert_id INTEGER NOT NULL, insert_id INTEGER NOT NULL, server_id INTEGER UNSIGNED NOT NULL, sql_text MEDIUMTEXT NOT NULL) engine=MyISAM CHARACTER SET utf8 comment="Slow log";
...
SET @cmd= "CREATE DATABASE IF NOT EXISTS `#bak_database` character set utf8";
